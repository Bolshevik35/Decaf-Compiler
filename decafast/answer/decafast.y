...
method_decl: /*case of empty typed_symbol_list */
    ...
    { $$ = new MethodAST(*$2, $5, new decafStmtList(), (MethodBlockAST*)$6); delete $2; }
...
expr: T_LPAREN expr T_RPAREN
    ...
    { $$ = $1; }
    | expr T_PLUS expr 
    { string *str = new string("Plus"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_MINUS expr 
    { string *str = new string("Minus"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_MULT expr 
    { string *str = new string("Mult"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_DIV expr
    { string *str = new string("Div"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_LEFTSHIFT expr
    { string *str = new string("Leftshift"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_RIGHTSHIFT expr
    { string *str = new string("Rightshift"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_MOD expr
    { string *str = new string("Mod"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_GT expr
    { string *str = new string("Gt"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_LT expr
    { string *str = new string("Lt"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_GEQ expr
    { string *str = new string("Geq"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_LEQ expr
    { string *str = new string("Leq"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_EQ expr
    { string *str = new string("Eq"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_NEQ expr
    { string *str = new string("Neq"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_AND expr
    { string *str = new string("And"); $$ = new BinaryExprAST(*str, $1, $3); }
    | expr T_OR expr
    { string *str = new string("Or"); $$ = new BinaryExprAST(*str, $1, $3); }
    | T_MINUS expr %prec UMINUS
    { string *str = new string("UnaryMinus"); $$ = new UnaryExprAST(*str, $2); }
    | T_NOT expr 
    { string *str = new string("Not"); $$ = new UnaryExprAST(*str, $2); }
    ;
